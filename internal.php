...
<a href="inline.php"><button class="btn btn-full" id="previous" name="PreviousPage">Previous Page </button></a>
<a href="internal.docx" Download="Internal CSS"><button class="btn btn-full" id="download">Download </button></a>
<a href="external.php"><button class="btn btn-full" id="next" name="NextPage">Next Page </button></a>
