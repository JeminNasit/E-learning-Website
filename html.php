...
<a href="HTML.docx" Download="Introduction to HTML"><button class="btn btn-full" id="download">Download </button></a>
<a href="structure.php"><button class="btn btn-full" id="next" name="NextPage">Next Page </button></a>
</div>
</nav>
</div>
</header>
