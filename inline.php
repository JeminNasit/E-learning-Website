...
<a href="css.php"><button class="btn btn-full" id="previous" name="PreviousPage">Previous Page </button></a>
<a href="Inline.docx" Download="Inline CSS"><button class="btn btn-full" id="download">Download </button></a>
<a href="internal.php"><button class="btn btn-full" id="next" name="NextPage">Next Page </button></a>
