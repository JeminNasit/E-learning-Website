...
...<br>
< / body ></p>
<a href="html.php"><button class="btn btn-full" id="previous" name="PreviousPage">Previous Page </button></a>
<a href="structure.docx" Download="Basic HTML Document Structure"><button class="btn btn-full" id="download">Download </button></a>
<a href="thefile.php"><button class="btn btn-full" id="next" name="NextPage">Next Page </button></a>
</div>
</nav>
</div>
</header>
